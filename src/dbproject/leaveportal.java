 ...
 * @author Hp
 */
public class leaveportal extends javax.swing.JFrame {

    /** Creates new form leaveportal */
    public leaveportal() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setForeground(new java.awt.Color(48, 27, 71));
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Requested By", "Date of Req", "Leave Start", "Leave End ", "Leave Desc", "Status"
            }
        ));
        jScrollPane2.setViewportView(jTable1);

        jPanel7.setBackground(new java.awt.Color(255, 255, 255));
        jPanel7.setPreferredSize(new java.awt.Dimension(131, 43));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel9.setText("REJECT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(leaveportal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new leaveportal().setVisible(true);
            }
        });
    }
