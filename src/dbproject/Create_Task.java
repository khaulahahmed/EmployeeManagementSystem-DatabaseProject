...
public class Create_Task extends javax.swing.JFrame {
    ...
    public Create_Task() {
        ...
        try {
            ...
            Logger.getLogger(Create_Task.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void setfieldsEmpty() {
        ...
        sdate2.setForeground(new java.awt.Color(204, 204, 204));
    ...
    private boolean checkfields() { //check if required fields are there
        if (taskname.getText().equals("") || taskdet.getText().equals("")
                || startdate1.getText().equals("") || sdate2.getText().equals("") || startdate3.getText().equals("")
            ...
            if (taskname.getText().trim().isEmpty()) {
                ...
                return true;
            } else if (sdate2.getText().trim().isEmpty()) {
                sdate2.grabFocus();
                return true;
    ...
    private void initComponents() {
        ...
        sdate1 = new javax.swing.JSpinner();
        ...
        sdate1.setFont(new java.awt.Font("Rockwell", 0, 11)); // NOI18N
        sdate1.setModel(new javax.swing.SpinnerNumberModel(1, 1, 30, 1));
        jPanel2.add(sdate1);
        sdate1.setBounds(20, 290, 70, 30);

        jSpinner1.setFont(new java.awt.Font("Rockwell", 0, 11)); // NOI18N
        jPanel2.add(jSpinner1);
        jSpinner1.setBounds(100, 290, 100, 30);

        jSpinner2.setFont(new java.awt.Font("Rockwell", 0, 11)); // NOI18N
        jPanel2.add(jSpinner2);
        jSpinner2.setBounds(210, 290, 80, 30);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if (!checkfields()) {
            ...
            String sdate = startdate1.getText() + " " + sdate2.getText() + " " + startdate3.getText();
    ...
    private void TaskMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TaskMouseClicked
        ...
        sdate2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        sdate2.setText(Sdate.substring(5, 7));
    ...
    private javax.swing.JSpinner sdate1;
